...
public class CursoHome {
	...
	public Curso findById(java.lang.Integer id) {
		...
		try {
			Curso instance = (Curso) sessionFactory.getCurrentSession().get("com.netbiis.Curso", id);
			if (instance == null) {
	...
	public List findByExample(Curso instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.netbiis.Curso")
